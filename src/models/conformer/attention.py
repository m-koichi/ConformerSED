...
if __name__ == "__main__":
    ...
    # model = MultiHeadSelfAttention(64, 8, 0.5)
    # n_head, d_model, d_head, d_inner, dropout,
    model = MyRelMultiHeadAttn(4, 144, 4, 0.5)
    print(model)
    breakpoint()
    x = torch.rand((100, 2, 64))  # (B, T, D)
    model(x)
    # summary(model.cuda(), (100, 64))
